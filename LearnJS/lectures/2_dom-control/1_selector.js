...
console.groupCollapsed('query item : ', item);

let itemAll = document.querySelectorAll('.item');
console.log('itemsAll : ', itemAll);
console.log('itemsAll[0] : ', itemAll[0]);
console.log('itemsAll[1] : ', itemAll[1]);
console.log('itemsAll[2] : ', itemAll[2]);
...
input.setAttribute('requird', '');
input.removeAttribute('placeholder');
input.removeAttribute('requird');
